...
const translations = {
  ...
  'en-US': {
    ...
    // Quiz Builder
    'quizBuilder.save': 'Save',
    'quizBuilder.saving': 'Saving...',
    'quizBuilder.publish': 'Publish',
    'quizBuilder.publishing': 'Publishing...',
    'quizBuilder.preview': 'Preview',
    'quizBuilder.tabs.editor': 'Editor',
    'quizBuilder.tabs.preview': 'Preview',
    'quizBuilder.tabs.flow': 'Advanced Flow',
    'quizBuilder.tabs.design': 'Design',
    'quizBuilder.tabs.settings': 'Settings',
    'quizBuilder.tabs.abTest': 'A/B Test',
    'quizBuilder.tabs.pixels': 'Pixels/Scripts',
    'quizBuilder.tabs.blackhat': 'BlackHat',
    'quizBuilder.messages.quizSaved': 'Quiz saved successfully',
    'quizBuilder.messages.errorSaving': 'Error saving quiz',
    'quizBuilder.messages.titleRequired': 'Title required',
    'quizBuilder.messages.titleRequiredDesc': 'Please add a title for the quiz in the "Settings" tab before saving.',
    'quizBuilder.messages.accessDenied': 'Access denied',
    'quizBuilder.messages.accessDeniedDesc': 'You need to be logged in to access the editor.',
    'quizBuilder.messages.unauthorized': 'Access Denied',
    'quizBuilder.messages.unauthorizedDesc': 'You have been logged out. Redirecting to login...',
