...
export default function QuizBuilder() {
  ...
  const [quizData, setQuizData] = useState({
    ...
    design: {
      ...
      showProgressBar: true,
      buttonColor: "#10b981",
      defaultButtonColor: "#10b981", // Cor padrão para novos botões
      defaultButtonTextColor: "#ffffff", // Cor padrão do texto de novos botões
        ...
        {activeTab === "editor" && (
          <div className="h-full">
            <PageEditorHorizontal
              ...
              defaultButtonColor={quizData.design?.defaultButtonColor || "#10b981"}
              defaultButtonTextColor={quizData.design?.defaultButtonTextColor || "#ffffff"}
