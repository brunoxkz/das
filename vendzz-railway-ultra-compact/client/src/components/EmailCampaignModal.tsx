...
import { ArrowRight, ArrowLeft, Send, Mail, AlertCircle, CheckCircle, Calendar, Users, Target, MessageSquare } from 'lucide-react';
...
export default function EmailCampaignModal({ children, onCampaignCreated }: EmailCampaignModalProps) {
  ...
  const emailCredits = userCredits?.breakdown?.email || 0;
  ...
  const createCampaignMutation = useMutation({
    ...
    onSuccess: () => {
      toast({
        ...
        description: "Sua campanha de email foi criada com sucesso!",
      });
  ...
  const handleCreateCampaign = async () => {
    ...
    if (emailCredits <= 0) {
      toast({
        ...
        description: `Você precisa de pelo menos 1 crédito de email para publicar uma campanha. Créditos atuais: ${emailCredits}`,
        variant: "destructive",
      });
      return;
    }
        ...
        return (
          <div className="space-y-4">
            <div>
              ...
              <Textarea
                id="campaign-content"
                placeholder="Olá! Obrigado por participar do nosso quiz. Aqui está sua oferta especial..."
            ...
            <div className="text-sm text-gray-600">
              <p>Dica: Use variáveis como {'{nome}'}, {'{email}'} para personalizar o conteúdo.</p>
            </div>
          </div>
        );
          ...
          {emailCredits <= 0 && (
            <div className="bg-red-50 border border-red-200 rounded-lg p-4">
              ...
              <p className="text-red-700 text-sm mt-1">
                Você precisa de pelo menos 1 crédito de email para publicar uma campanha. Créditos atuais: {emailCredits}
              </p>
            </div>
          )}
          ...
          {emailCredits > 0 && (
            <div className="bg-green-50 border border-green-200 rounded-lg p-4">
              <div className="flex items-center gap-2">
                ...
                <span className="text-green-800 font-medium">Créditos Disponíveis: {emailCredits}</span>
              </div>
          ...
          <div className="flex justify-end gap-2">
            ...
            {currentStep < 4 ? (
              ...
              <Button 
                ...
                disabled={isCreating || emailCredits <= 0}
